...
export const SortableCard: React.FC<CardProps> = ({ id, text, isLocked, isDragging, isOverlay, isFailed, isGold }) => {
  const {
    attributes,
    listeners,
    setNodeRef,
  ...
  return (
    <div
      ...
      style={style}
      className={cn(
        "relative flex items-center p-4 mb-3 rounded-2xl border-2 shadow-sm transition-colors duration-200",
        isLocked 
          ? isGold 
